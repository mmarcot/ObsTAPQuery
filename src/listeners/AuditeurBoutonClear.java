...
public class AuditeurBoutonClear implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if( JOptionPane.showConfirmDialog(plug_lay, Langage.getReq_clear_message_dialog(), Langage.getReq_clear_titre_dialog(), JOptionPane.YES_NO_CANCEL_OPTION) == JOptionPane.YES_OPTION ) {		
			// on nettoye tout :
